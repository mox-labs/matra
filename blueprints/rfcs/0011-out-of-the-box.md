# RFC-0011: Out of the box: configuration, paths, and one CLI

- Feature Name: `out_of_the_box`
- Start Date: 2026-09-05
- RFC PR: [#62](https://github.com/mox-labs/matra/pull/62)
- Tracking EP: [EP-0010](../eps/0010-foundations.md)
- Status: implemented
...
We choose Option B for configuration and collapse the CLIs to one implementation with two launchers.
...
3. **The semantic tier is not out of the box.** RFC-0010 decision 6
...
**Pinned downloads are the same discipline for every model.** RFC-0010
...
- ROADMAP.md, "Configuration-driven invocation" (trigger fired
  2026-09-05)
- [RFC-0007](0007-one-pipeline.md): the surface these constructors
  extend
- [RFC-0010](0010-embeddings-adapter.md): decision 6, amended here
- `blueprints/eps/0010-foundations.md`: the execution plan
- [Conventions survey, 2026-09-05](../../docs/surveys/2026-09-05-conventions.md):
