# RFC-0004: Stay single-crate; supersede the workspace split proposal

- Feature Name: `stay_single_crate`
- Start Date: 2026-05-20
- RFC PR: [#5](https://github.com/mox-labs/matra/pull/5)
- Tracking EP: none
- Status: accepted
...
matra stays a single Cargo crate at `mox/packages/matra/`. The workspace split proposed in RFC-0003 is retracted.

## Motivation

RFC-0003 (2026-05-01) proposed splitting matra into a Cargo workspace with two crates: `matra-core` (the substrate) and a sibling matcher-bridge crate. The proposal was never implemented; the working code has remained a single crate.
...
The proposal in RFC-0003 was internally coherent but no longer matches the project's direction.
