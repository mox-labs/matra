...
| [0017](0017-harness-layers.md) | The harness: one deterministic suite, a remote runner that adds only what it must, durable facts in the repository, and a steward that reads them | proposed |
