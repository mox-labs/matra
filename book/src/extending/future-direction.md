...
This discipline is named in `.claude/arch/evolution.md` and `.claude/skills/aces/SKILL.md`. The shorthand: build the dirt road first, the cobblestone when traffic justifies it, the tarmac when traffic demands it.
