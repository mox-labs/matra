...
- [Domain types](./concepts/domain-types.md)
...
- [Writing a new adapter](./extending/new-adapter.md)
- [Future direction](./extending/future-direction.md)
...
[ACES and antifragility](./philosophy.md)
