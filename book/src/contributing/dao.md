...
The same change might fly past one agent and fail another. The reviewer might see a clean PR; the resilience agent might see an unbounded input. The DAO works because the lenses don't fully overlap.
